...
int send_tcp_pkt(Udp_Probe_Pkt *pkt, uint32_t pkt_idx, uint32_t chirp_len, int sd, struct sockaddr_in *dst);
int recv_tcp_pkt(int sd, Udp_Probe_Pkt *pkt);
...
int recv_chirp_tcp(int sd, Udp_Probe_Pkt **p);
